...
- **Monitor**: Add failsafe temperatures if VR or ASIC excedd these then drop frequency & voltage to less than default. These may cater for a fan breakdown & turn the device really low (effectively off)
